RSpec.describe Peatio::Tradecoin::Wallet do
  let(:wallet) { Peatio::Tradecoin::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::Tradecoin::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::Tradecoin::Wallet::SUPPORTED_SETTINGS))
    end
  end
